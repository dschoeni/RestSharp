...
namespace RestSharp.Serializers
{
	...
	/// </summary>
    // TODO: Make the XmlSerializer work
	public sealed class XmlSerializer : ISerializer
	{
		...
		private void Map(XElement root, object obj) {
            ...
            //var props = from p in System.Reflection.IntrospectionExtensions.GetTypeInfo(objType).DeclaredProperties
            //            let indexAttribute = p.GetAttribute<SerializeAsAttribute>()
            //            where p.CanRead && p.CanWrite
            //            orderby indexAttribute == null ? int.MaxValue : indexAttribute.Index
            //            select p;
            ...
            //    var propTypeInfo = System.Reflection.IntrospectionExtensions.GetTypeInfo(propType);
            //    if (propTypeInfo.IsPrimitive || propTypeInfo.IsValueType || propType == typeof(string)) {
            //        if (useAttribute) {
