...
namespace RestSharp
{
    ...
    internal class SimpleJson
    {
        ...
        public static object DeserializeObject(string json, Type type, IJsonSerializerStrategy jsonSerializerStrategy)
        {
            ...
            return type == null || jsonObject != null && jsonObject.GetType().GetTypeInfo().IsAssignableFrom(type.GetTypeInfo()) ? jsonObject
        ...
        public static IJsonSerializerStrategy CurrentJsonSerializerStrategy
        {
            get
            {
                ...
                return currentJsonSerializerStrategy ??
                    (currentJsonSerializerStrategy = PocoJsonSerializerStrategy);
            }
