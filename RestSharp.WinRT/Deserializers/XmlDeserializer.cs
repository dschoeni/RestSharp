...
namespace RestSharp.Deserializers
{
	public sealed class XmlDeserializer : IDeserializer
	{
		...
		private void Map(object x, XElement root)
		{
            ...
            var props = System.Reflection.IntrospectionExtensions.GetTypeInfo(objType).DeclaredProperties;
			...
			foreach (var prop in props)
			{
                ...
                if (!System.Reflection.IntrospectionExtensions.GetTypeInfo(type).IsPublic || !prop.CanWrite)
					continue;
                ...
                //    if (System.Reflection.IntrospectionExtensions.GetTypeInfo(type).IsGenericType)
                //    {
                ...
                //if (System.Reflection.IntrospectionExtensions.GetTypeInfo(type).IsGenericType && type.GetGenericTypeDefinition() == typeof(Nullable<>))
                //{
                ...
                //else if (System.Reflection.IntrospectionExtensions.GetTypeInfo(type).IsPrimitive)
                //{
                //    prop.SetValue(x, value.ChangeType(type), null);
                //}
                ////else if (type.IsEnum)
                //else if (System.Reflection.IntrospectionExtensions.GetTypeInfo(type).IsEnum)
                //{
                //    var converted = type.FindEnumValue(value.ToString());
                ...
                //{
                //    value = Decimal.Parse(value.ToString(), CultureInfo.CurrentCulture);
                //    prop.SetValue(x, value, null);
                //}
		...
		private object HandleListDerivative(object x, XElement root, string propName, Type type)
		{
			...
			else
			{
                ...
                t = System.Reflection.IntrospectionExtensions.GetTypeInfo(type).BaseType.GenericTypeArguments[0];
			}
		...
		private object CreateAndMap(Type t, XElement element)
		{
            ...
            else if (System.Reflection.IntrospectionExtensions.GetTypeInfo(t).IsPrimitive)
			{
